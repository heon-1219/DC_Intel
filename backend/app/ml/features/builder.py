...
Documented v1 choices (see docs .../m5-...md):
  * Cross-market features (xmkt_ref_return, xmkt_corr_60d) are deferred -> always missing.
...
async def build_features(con, redis, stock_ref, timeframe: str, as_of: str):
    ...
    # --- cross-market (v1 deferred -> missing) ------------------------------------------------
    # xmkt_ref_return / xmkt_corr_60d intentionally left None+missing (see module docstring).
